...
void DSNhanVien::InputAddMode(NhanVien &newNhanVien)
{
	...
	case DSNhanVien::themMa:
		InputInfo(newNhanVien.maNV, 24, 60, 10, keypress, 1);
		break;
	case DSNhanVien::themHo:
		InputInfo(newNhanVien.ho, 24, 60, 15, keypress, 3);
		break;
	case DSNhanVien::themTen:
		InputInfo(newNhanVien.ten, 24, 60, 20, keypress, 3);
		break;
...
void DSNhanVien::InputFixMode(NhanVien &info)
{
	...
	{
	case DSNhanVien::themMa:
		InputInfo(info.maNV, 24, 60, 10, keypress, 1);
		break;
	case DSNhanVien::themHo:
		InputInfo(info.ho, 24, 60, 15, keypress, 3);
		break;
	case DSNhanVien::themTen:
		InputInfo(info.ten, 24, 60, 20, keypress, 3);
		break;
	case DSNhanVien::themPhai:
		ChooseSex(info.phai);
		break;
